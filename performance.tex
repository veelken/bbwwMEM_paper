...
published by the ATLAS collaboration for simulated $\ttbar$ events during LHC Run $2$,
which is shown in Fig.~9 of Ref.~\cite{ATLAS:2018txj} and amounts to $25$-$30$~\GeV~\footnote{
...
\ifx\ver\verPAPER
\centering
\includegraphics[width=0.57\textwidth]{plots/lo_vs_nlo_ROC.pdf}
\fi
\caption{
