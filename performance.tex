...
taking the $\PHiggs$ boson mass to be $m_{\PHiggs} = 125$~\GeV and a top quark mass to be $m_{\Ptop} = XXX.X$~\GeV[CV: CHECK TOP QUARK MASS USED TO PRODUCE MC SAMPLES].
...
The effect of experimental resolutions on the distributions in $P(\vecy)$ and on the ROC curve is estimated
...
%\put(4.0, 62.0){\mbox{\includegraphics*[height=54mm]
%{plots/hh_bbwwMEM_dilepton_effectOfFakes_2histograms_probS_signal.pdf}}}
%\put(84.0, 62.0){\mbox{\includegraphics*[height=54mm]
