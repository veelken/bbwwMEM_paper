...
Our model for the jet energy resolution agrees with the resolution measured by the CMS collaboration during LHC Run $2$, shown in Fig.~3 of Ref.~\cite{JME-18-001}.
...
The resolution on $\pX^{\rho}$ and $\pY^{\rho}$ in the $\textsc{DELPHES}$ simulation amounts to $32.4$~\GeV for the $\dihiggs$ signal and to $30.3$~\GeV for the $\ttbar$ background.
The resolution on the energy of $\Pbottom$-jets is small compared to the resolution on the hadronic recoil.
The resolution on the latter is thus dominated by the resolution on $\vecMET$,
which allows us to compare the resolutions on $\pX^{\rho}$ and $\pY^{\rho}$ in the $\textsc{DELPHES}$ simulation to the resolution on $\vecMET$
published by ATLAS and CMS during LHC Run $2$.
...
similar to what we find in the $\textsc{DELPHES}$ simulation with the card for the CMS detector 
...
For a signal efficiency of $35\%$, the $\ttbar$ background is reduced by almost three orders of magnitude, to a level of $1.2$ permille, in case the LR is computed at MC-truth level.
...
selects $68.9\%$ ($86.9\%$) of the $\dihiggs$ signal and $22.1\%$ ($40.6\%$) of the $\ttbar$ background.
