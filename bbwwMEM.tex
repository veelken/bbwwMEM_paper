...
\usepackage{hepnames,bm,multirow,amssymb,xspace,hyperref,lineno,amsmath,bm,multirow,authblk,graphicx,newclude,rotating,cite}
\fi
\ifx\ver\verPAPER
...
\newcommand{\METxhat}{\ensuremath{\hat{p}_{\textrm{x}}^{\textrm{\kern0.10em miss}}}\xspace}
\newcommand{\METy}{\ensuremath{p_{\textrm{y}}^{\textrm{\kern0.10em miss}}}\xspace}
\newcommand{\METyhat}{\ensuremath{\hat{p}_{\textrm{y}}^{\textrm{\kern0.10em miss}}}\xspace}
...
\newcommand{\mbb}{\ensuremath{m_{\Pbottom\Pbottom}}}
