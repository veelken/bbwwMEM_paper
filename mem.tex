...
The CMS collaboration computes the matrix $V$ on an event-by-event bases, using an algorithm referred to as the ``$\MET$-significance'' algorithm~\cite{JME-10-009}.
