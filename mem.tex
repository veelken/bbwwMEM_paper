...
\begin{linenowrapper}
\begin{align}
w_{i}(\vecy|\vecyhat) = & \frac{\Omega(\vecy)}{\sigma_{i} \cdot \mathcal{A}_{i}} \, \int \, d\xhat_{a} \, d\xhat_{b} \,
...
and neglecting the small transverse momenta of the partons within the protons.
