...
$\PHiggs\PHiggs \to \Pbottom\Pbottom\PW\PW^{\ast} \to \Pbottom\Pbottom \, \ellPlusnu\ellMinusnu$
...
As already mentioned, $\PHiggs\PHiggs \to \Pbottom\Pbottom\PW\PW^{\ast} \to \Pbottom\Pbottom \, \ellPlusnu\ellMinusnu$ signal events
contain the same number of $\Pbottom$-jets, charged leptons, and neutrinos as the dominant background,
arising from $\ttbar \to \Pbottom\PW\Pbottom\PW \to \Pbottom\ellPlusnu \, \Pbottom\ellMinusnu$.
...
We use ME generated at LO accuracy with the program MadGraph\_aMCatNLO 2.2.2~\cite{MadGraph_aMCatNLO} for the signal as well as for the background hypothesis[CV: CHECK MADGRAPH VERSION USED TO GENERATE ME].
...
The CMS collaboration computes the matrix $V$ on an event-by-event bases, using an algorithm referred to as ``$\MET$-significance'' algorithm~\cite{JME-10-009}.
...
and take the matrix $V$ to be $V = \sigma_{\rho}^{2} \, I_{2}$, where $I_{2}$ denotes the identity matrix of size $2$.
...
$\PHiggs\PHiggs \to \Pbottom\Pbottom\PW\PW^{\ast} \to \Pbottom\Pbottom \, \ellPlusnu\ellMinusnu$ and
$\ttbar \to \Pbottom\PW\Pbottom\PW \to \Pbottom\ellPlusnu \, \APbottom\ellMinusnu$.
Their presence renders the numeric integration inefficient, unless the mass constraints are treated analytically. 
We use the narrow-width approximation~\cite{NWA} to handle the mass constraints and replace the BW propagators by $\delta$-functions,
which has the effect of restricting the numerical integration to the narrow slices in the $6$-particle PS where the mass constraints are satisfied
...
In $\PHiggs\PHiggs \to \Pbottom\Pbottom\PW\PW^{\ast} \to \Pbottom\APbottom \, \ellPlusnu\ellMinusnu$ signal events,
either the $\PW^{+}$ or the $\PW^{-}$ boson is off-shell.
We use an asterisk to refer to the charged lepton and the neutrino that originate from the decay of the off-shell $\PW$ boson.
...
In $\ttbar \to \Pbottom\PW\Pbottom\PW \to \Pbottom\ellPlusnu \, \Pbottom\ellMinusnu$ background events,
...
to indicate that they refer to the anti-neutrino and to the anti-bottom quark produced in the decay of the anti-top quark.
...
as both $\PW$ bosons are on-shell in case of the background hypothesis,
