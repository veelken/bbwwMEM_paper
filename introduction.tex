...
\begin{center}
\begin{tabular}{ccc}
\raisebox{-.45\height}{\resizebox{0.3\textwidth}{!}{\input{./fdiags/hh_triangle}}} &
\qquad + &
\raisebox{-.45\height}{\resizebox{0.3\textwidth}{!}{\input{./fdiags/hh_box}}}
\end{tabular}
...
\begin{center}
\begin{tabular}{ccc}
\raisebox{-.45\height}{\resizebox{0.3\textwidth}{!}{\input{./fdiags/ttbar_tri}}} &
\qquad + &
\raisebox{-.45\height}{\resizebox{0.3\textwidth}{!}{\input{./fdiags/ttbar}}}
\end{tabular}
%\begin{picture}(160,54)(0,0)
