...
\begin{center}
\begin{tabular}{ccc}
\raisebox{-.45\height}{\resizebox{0.43\textwidth}{!}{\includegraphics{figures/hh_triangle.pdf}}} &
\qquad + &
\raisebox{-.45\height}{\resizebox{0.43\textwidth}{!}{\includegraphics{figures/hh_box.pdf}}}
\end{tabular}
...
\begin{center}
\begin{tabular}{ccc}
\raisebox{-.45\height}{\resizebox{0.4\textwidth}{!}{\includegraphics{figures/ttbar_tri.pdf}}} &
\qquad + &
\raisebox{-.45\height}{\resizebox{0.4\textwidth}{!}{\includegraphics{figures/ttbar.pdf}}}
\end{tabular}
