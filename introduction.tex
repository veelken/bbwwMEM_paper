...
\begin{center}
\begin{tabular}{ccc}
\raisebox{-.45\height}{\resizebox{0.4\textwidth}{!}{\includegraphics{./fdiags/hh_triangle.pdf}}} &
\qquad + &
\raisebox{-.45\height}{\resizebox{0.4\textwidth}{!}{\includegraphics{./fdiags/hh_box.pdf}}}
\end{tabular}
