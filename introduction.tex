...
Recent analyses of data collected during LHC Run $2$ corroborate this value~\cite{}.
...
\begin{center}
\begin{tabular}{ccc}
\raisebox{-.45\height}{\resizebox{0.43\textwidth}{!}{\includegraphics{./fdiags/hh_triangle.pdf}}} &
\qquad + &
\raisebox{-.45\height}{\resizebox{0.43\textwidth}{!}{\includegraphics{./fdiags/hh_box.pdf}}}
\end{tabular}
%\begin{picture}(170,30)(0,0)
%\put(  2.5, 0.0){\mbox{\includegraphics*[height=30mm]{figures/feynman_nonresonant_triangle.pdf}}}
%\put( 90.5, 0.0){\mbox{\includegraphics*[height=30mm]{figures/feynman_nonresonant_box.pdf}}}
%\end{picture}
\end{center}
\caption{
  Leading order (LO) Feynman diagrams for the $\ggHH$ production process in $\Pp\Pp$ collisions at the LHC,
  with subsequent decay of the $\PHiggs$ boson pair via $\PHiggs\PHiggs \to \Pbottom\APbottom\PW\PW^{\ast} \to \Pbottom\APbottom \, \ellPlusnu\ellMinusnu$.
...
\begin{center}
\begin{tabular}{ccc}
\raisebox{-.45\height}{\resizebox{0.4\textwidth}{!}{\includegraphics{./fdiags/ttbar_tri.pdf}}} &
\qquad + &
\raisebox{-.45\height}{\resizebox{0.4\textwidth}{!}{\includegraphics{./fdiags/ttbar.pdf}}}
\end{tabular}
...
The separation of the $\dihiggs$ signal from the large $\ttbar$ background constitutes the main experimental challenge in the $\Pbottom\APbottom\PW\PW^{\ast}$ channel.
